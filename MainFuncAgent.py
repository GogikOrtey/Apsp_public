...
Тогда по планам:
    ...
    * Отобрать 12 лучших сайтов
        * И из них извлечь данные для parseCard
        * И для parsePage
    * Протестировать parseCard на них, отладить
    * Протестировать parsePage на них, отладить
    * Написать global_code, что бы он собирал всё вместе, в итоговый файл с кодом
        * Протестировать прогоном на всех доступных примерах
    + И в целом back на этом будет готов
