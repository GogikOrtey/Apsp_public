...
Допилить 2 момента в промптах:

- Инструкции в Ментальной модели, формировании JSON и в ещё одном месте дублируются

Затем:

- Прописать, что для запуска агента - нужно сформулировать задачу, прописать схему результата и шаблон (и возможно что-то ещё)
