...
Если это количество например увеличилось в два и более раз - значит на странице выполняется подгрузка результатов через дополнительные запросы. Зафиксируй это в result: в поле is_site_used_add_request = true. 
...
- Извлеки название и цену 2го товара. Сохрани их в result в поля name_second_ptoduct и price_second_ptoduct.
...
выполни поиск по названию товара (или по части названия)
    ...
    - Если поиск по истории запросов по названию второго товара не дал результатов, то повтори поиск с ценой (значение записано в result в поле price_second_ptoduct)
