...
му что в данном инструменте/парсере не поддерживаются псевдоселекторы :has/:contains. Поэтому сначала извлекаю список всех li в ul.product-card-attributes, 
