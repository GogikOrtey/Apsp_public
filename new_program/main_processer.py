...
- Прописать формально, что бы Я делал, для того что бы написать код parsePage, имея данные на 4м шаге
    - И это же пускай будет делать агент
- Сделать что бы он в итоге собирал валидный код parsePage
