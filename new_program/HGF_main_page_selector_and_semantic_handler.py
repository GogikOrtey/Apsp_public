...
2. Сбор семантики:
    ...
    - Отдавай приоритет более точным словам, обозначающим конкретные предметы и собирай меньше общих, описывающих группы и категории товаров. Например, слова для семантики "дверь", "ванна", "дрель", "линолиум" - будут лучше, чем общие слова "сантехника", "инструмент", "напольные".
