...
"""
    ...
    - Селектор товара - ссылки на товар
        - в ссылке может не быть схемы и хоста, это нормально
        - надо будет визуально посмотреть, что у разных элементов с этим классом все ссылки будут различаться
