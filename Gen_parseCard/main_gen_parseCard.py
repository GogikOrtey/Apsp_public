...
Используй инструмент ########## для проверки кода обработки текущего поля. Этот инструмент принимает массив ссылок - можно передать несколько, или одну, и он выполнит его на всех переданных страницах, и вернёт результат также в массиве, в таком-же порядке элементов.
...
Тебе нужно будет проанализировать, что 
