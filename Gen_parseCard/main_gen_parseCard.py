...
И запиши составленный код в result в ячейку с названием текущего поля field__[название поля]__code. И в тактическом плане (steps_future) укажи, что код составлен, и можно переходить к его проверке.

2. Если в ячейке field__[название поля]__code есть код, то значит нужно проверить его на трёх страницах, и записать значения true если проверка будет успешна. Посмотри, если для всех трёх полей 
