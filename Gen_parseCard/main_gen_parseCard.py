...
Здесь тебе нужно будет запустить написанный код, для извлечения значений поля. Этот код уже будет записан в ячейке field__[название поля]__code в result. Для запукска и валидации используй инструмент run_cheerio_js_extract_vars
