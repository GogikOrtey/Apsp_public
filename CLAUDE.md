...
- **`GET|POST /auto_solving_problem_page_1`**: страница "ASP: Центр автоматизации решения проблем и починки парсеров" (пока UI-страница с типовыми проблемами + textarea"“Решить проблему"). Кнопка “центр” на `start_page_1` ведёт сюда.
